...
$the_link_text_escaped = ($link_style === 'nectar-button') ? wp_kses_post($link_text) : '<span class="screen-reader-text">'.esc_html__('Play Video','salient-core').'</span><span class="play"><span class="inner-wrap inner"><svg role="none" version="1.1"
